...
from test_framework.address import (
    ...
    ADDRESS_RGRT1_UNSPENDABLE_DESCRIPTOR,
)
...
class WalletBlankTest(RegusTestFramework):
    ...
    def test_importaddress(self):
        ...
        wallet.importaddress(ADDRESS_RGRT1_UNSPENDABLE)
    ...
    def test_importmulti(self):
        ...
        assert_equal(info["blank"], True)
        wallet.importmulti([{
            "desc": ADDRESS_RGRT1_UNSPENDABLE_DESCRIPTOR,
            "timestamp": "now",
        }])
        assert_equal(wallet.getwalletinfo()["blank"], False)
