...
class TxnMallTest(RegusTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 REG:
        ...
        # First: use raw transaction API to send 1240 REG to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 REG coin each
        ...
        # Node0's balance should be starting balance, plus 50REG for another
        ...
        # Node0's total balance should be starting balance, plus 100REG for
