...
class ReplaceByFeeTest(RegusTestFramework):
    ...
    def test_doublespend_chain(self):
        ...
        # child fees - 4 REG - so this attempt is rejected.
    ...
    def test_rpc(self):
        ...
        ins = [us0]
        outs = {ADDRESS_RGRT1_UNSPENDABLE: Decimal(1.0000000)}
