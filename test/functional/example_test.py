...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the RegusTestFramework
    pass


class ExampleTest(RegusTestFramework):
    # Each functional test is a subclass of the RegusTestFramework class.
    ...
    def custom_method(self):
        ...
        RegusTestFramework class so other tests can use it."""
