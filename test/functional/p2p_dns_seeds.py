...
class P2PDNSSeeds(RegusTestFramework):
    ...
    def init_arg_tests(self):
        ...
        # Restore default regusd settings
        self.restart_node(0)
    ...
    def existing_outbound_connections_test(self):
        ...
        self.nodes[0].addpeeraddress("192.0.0.8", 4610)
    ...
    def force_dns_test(self):
        ...
        with self.nodes[0].assert_debug_log(expected_msgs=["Loading addresses from DNS seed"], timeout=12):
            # -dnsseed defaults to 1 in regusd, but 0 in the test framework,
