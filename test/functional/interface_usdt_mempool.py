...
"""  Tests the mempool:* tracepoint API interface.
     See https://github.com/RegusCrypto/Regus/blob/master/docs/tracing.md#context-mempool
"""
...
class MempoolTracepointTest(RegusTestFramework):
    ...
    def rejected_test(self):
        ...
        # https://github.com/RegusCrypto/Regus/issues/27380
