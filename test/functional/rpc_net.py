...
class NetTest(RegusTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=4610)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 4610)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=4610), {"success": False})
