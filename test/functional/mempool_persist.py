...
By default, regusd will dump mempool on shutdown and
...
class MempoolPersistTest(RegusTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent regusd from writing mempool.dat to disk. Verify that `savemempool` fails")
