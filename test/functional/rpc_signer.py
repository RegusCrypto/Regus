...
Verify that a regusd node can use an external signer command.
...
class RPCSignerTest(RegusTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart regusd with -signer=<cmd>',
