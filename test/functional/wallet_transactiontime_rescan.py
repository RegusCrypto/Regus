...
class TransactionTimeRescanTest(RegusTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine REG and create transactions
        ...
        # generate some reg to create transactions and check blockcount
        ...
        # send 10 reg to user's first watch-only address
        self.log.info('Send 10 reg to user')
        ...
        # send 5 reg to our second watch-only address
        self.log.info('Send 5 reg to user')
        ...
        # send 1 reg to our third watch-only address
        self.log.info('Send 1 reg to user')
