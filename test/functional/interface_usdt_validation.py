...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/RegusCrypto/Regus/blob/master/docs/tracing.md#context-validation
"""
...
class ValidationTracepointTest(RegusTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/RegusCrypto/Regus/blob/master/docs/tracing.md#tracepoint-validationblock_connected
        ...
        block_hashes = self.generatetoaddress(
            self.nodes[0], BLOCKS_EXPECTED, ADDRESS_RGRT1_UNSPENDABLE)
