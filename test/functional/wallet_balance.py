...
from test_framework.address import ADDRESS_RGRT1_UNSPENDABLE as ADDRESS_WATCHONLY
...
class WalletTest(RegusTestFramework):
    ...
    def run_test(self):
        ...
        # Send 40 REG from 0 to 1 and 60 REG from 1 to 0.
        ...
        # REG, which is more than would be available if transaction 1 were
        # replaced.
