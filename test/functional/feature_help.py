...
"""Verify that starting regus with -h works as expected."""

from test_framework.test_framework import RegusTestFramework
from test_framework.util import assert_equal

class HelpTest(RegusTestFramework):
    ...
    def run_test(self):
        self.log.info("Start regus with -h for help text")
        ...
        self.log.info("Start regus with -version for version information")
        ...
        self.log.info("Start regusd with -fakearg to make sure it does not start")
