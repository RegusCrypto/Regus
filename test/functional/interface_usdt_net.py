...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/RegusCrypto/Regus/blob/master/docs/tracing.md#context-net
"""
...
class NetTracepointTest(RegusTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our regusd node")
