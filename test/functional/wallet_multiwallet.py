...
Verify that a regusd node can load multiple wallet files
"""
...
class MultiWalletTest(RegusTestFramework):
    ...
    def run_test(self):
        ...
        #   w8         - to verify existing wallet file is loaded correctly. Not tested for SQLite wallets as this is a deprecated behavior.
        ...
        if not self.options.descriptors:
            # This tests the default wallet that SQLite makes
