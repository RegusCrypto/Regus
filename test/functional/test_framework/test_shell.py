...
class TestShell:
    """Wrapper Class for RegusTestFramework.

    The TestShell class extends the RegusTestFramework
    ...
    class __TestShell(RegusTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by RegusTestFramework child class.
            self.num_nodes = 1
