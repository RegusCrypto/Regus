...
"""Test framework for regus utils.
...
def main():
    ...
    bctester(os.path.join(env_conf["SRCDIR"], "test", "util", "data"), "regus-util-test.json", env_conf)
...
def bctest(testDir, testObj, buildenv):
    ...
    if testObj["exec"] == "./regus-util":
        execprog = os.getenv("REGUSUTIL", default=execprog)
    elif testObj["exec"] == "./regus-tx":
        execprog = os.getenv("REGUSTX", default=execprog)
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, regus-tx
