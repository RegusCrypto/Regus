...
"""Example logging Regus Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/regusd
...
def main(regusd_path):
    ...
    b = BPF(text=program, usdt_contexts=[regusd_with_usdts])
