...
""" Interactive regusd P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for Regus Core can enable. It uses BCC
...
def main(regusd_path):
    ...
    regusd_with_usdts.enable_probe(
