...
(define* (make-regus-cross-toolchain target
                                       #:key
...
desirable for building Regus Core release binaries."
...
;; failure; see https://github.com/RegusCrypto/Regus/pull/27296.
  ...
  (let ((target (getenv "HOST")))
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (make-regus-cross-toolchain target)))
