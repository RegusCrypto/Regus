...
complete --command regusd --no-files

# Extract options
function __fish_regusd_get_options
...
complete \
    --command regusd \
    --arguments "(__fish_regusd_get_options --nofiles)"
