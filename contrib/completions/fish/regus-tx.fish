...
# Extract options
function __fish_regus_tx_get_options
...
# Extract commands
function __fish_regus_tx_get_commands
...
complete \
    --command regus-tx \
    --condition "not __fish_regus_seen_cmd (__fish_regus_tx_get_commands --commandsonly)" \
    --arguments "(__fish_regus_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command regus-tx \
    --arguments "(__fish_regus_tx_get_commands)" \
    --no-files
