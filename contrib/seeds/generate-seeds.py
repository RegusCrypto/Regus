...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef REGUS_CHAINPARAMSSEEDS_H\n')
    g.write('#define REGUS_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the regus network\n')
    ...
    g.write('#endif // REGUS_CHAINPARAMSSEEDS_H\n')
