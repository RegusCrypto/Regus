...
Arguments:
    <base_directory> - The base directory of a regus source code repository.
...
Arguments:
    <file> - A source file in the regus repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Regus
