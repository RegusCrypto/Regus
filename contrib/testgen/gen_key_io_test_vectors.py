...
SCRIPT_ADDRESS_TEST = 63
PUBKEY_ADDRESS_REGTEST = 66
SCRIPT_ADDRESS_REGTEST = 63
PRIVKEY = 128
PRIVKEY_TEST = 239
PRIVKEY_REGTEST = 239
...
bech32_templates = [
  ...
  ('rgs',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rgs',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rgs',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('rgs',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('rgt',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rgt',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rgt',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('rgt',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('rgrt',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rgrt',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rgrt',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rgrt', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, encoding, invalid_bech32, invalid_checksum, invalid_char
  ('rt',    0, 20, Encoding.BECH32,  False, False, False),
  ('rg',    1, 32, Encoding.BECH32M, False, False, False),
  ('rgt',   17, 32, Encoding.BECH32M, False, False, False),
  ('rgrt',  3,  1, Encoding.BECH32M, False, False, False),
  ('rgs',   15, 41, Encoding.BECH32M, False, False, False),
  ('rgt',    0, 16, Encoding.BECH32,  False, False, False),
  ('rgrt',  0, 32, Encoding.BECH32,  True,  False, False),
  ('rgs',    0, 16, Encoding.BECH32,  True,  False, False),
  ('rgt',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rgrt',  0, 20, Encoding.BECH32,  False, False, True),
  ('rgs',    0, 20, Encoding.BECH32M, False, False, False),
  ('rgt',    0, 32, Encoding.BECH32M, False, False, False),
  ('rgrt',  0, 20, Encoding.BECH32M, False, False, False),
  ('rgs',    1, 32, Encoding.BECH32,  False, False, False),
  ('rgt',    2, 16, Encoding.BECH32,  False, False, False),
  ('rgrt', 16, 20, Encoding.BECH32,  False, False, False),
]
