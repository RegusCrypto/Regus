...
#ifndef REGUS_PRIMITIVES_TRANSACTION_H
#define REGUS_PRIMITIVES_TRANSACTION_H
...
public:
     ...
     * multiplying by 3 = 2^4, or equivalently shifting up by
     * 4 bits. */
    static const int SEQUENCE_LOCKTIME_GRANULARITY = 4;
...
#endif // REGUS_PRIMITIVES_TRANSACTION_H
