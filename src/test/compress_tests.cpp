...
// amounts 1 .. 10000
#define NUM_MULTIPLES_1REG 10000

// amounts 2000 .. 45000000000
#define NUM_MULTIPLES_2000REG 2250000
...
BOOST_AUTO_TEST_CASE(compress_amounts)
{
    ...
    BOOST_CHECK(TestPair(      2000*COIN,      0x7d0));
    BOOST_CHECK(TestPair(4500000000*COIN, 0x10c388d00));
    ...
    for (uint64_t i = 1; i <= NUM_MULTIPLES_1REG; i++)
        BOOST_CHECK(TestEncode(i * COIN));

    for (uint64_t i = 1; i <= NUM_MULTIPLES_2000REG; i++)
        BOOST_CHECK(TestEncode(i * 2000 * COIN));
