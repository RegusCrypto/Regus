...
#ifndef REGUS_TEST_SCRIPTNUM10_H
#define REGUS_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Regus Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // REGUS_TEST_SCRIPTNUM10_H
