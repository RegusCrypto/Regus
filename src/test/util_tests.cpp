...
BOOST_AUTO_TEST_CASE(util_ParseMoney)
{
    ...
    BOOST_CHECK(!ParseMoney("5000000000.00"));
...
BOOST_AUTO_TEST_CASE(test_LocaleIndependentAtoi)
{
    ...
    // Ensure legacy compatibility with previous versions of Regus Core's atoi64
    for (const auto& pair : atoi64_test_pairs) {
...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("regus"), "Regus");
...
BOOST_AUTO_TEST_CASE(message_sign)
{
    const std::array<unsigned char, 32> privkey_bytes = {
        ...
        // derived address from this private key: GbcEJMe6vRtpZ1wrmQ25PndF1qkYuAD8wA
        0xF1, 0x5F, 0xBE, 0xDD, 0xC2, 0x8C, 0xCC, 0x2A,
        0xDE, 0xB6, 0xD3, 0x99, 0x8C, 0x27, 0xA5, 0x8C,
        0x7F, 0x4B, 0x7E, 0xF3, 0x00, 0x0E, 0x2D, 0x88,
        0x78, 0x56, 0x12, 0xC0, 0x44, 0x3B, 0x83, 0xDA
    };

    const std::string message = "Trust no one";

    const std::string expected_signature =
        "H8D/qw2c61f8nGxnfF7bbJFkZZUHoeWSRTlRvrefauViXVDMpeFa1mK7qGeN3lHBvgRMNEZFX3UT0TlQ5CJF6ZY=";
...
BOOST_AUTO_TEST_CASE(message_verify)
{
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "XfeKVZR2gnc9qgp4CXUH8TVduffP8hpREg",
            "signature should be irrelevant",
            "message too"),
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "GSkXA1c58XFtJQX1MCHKpGhLKHurpJBMUM",
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "GbcEJMe6vRtpZ1wrmQ25PndF1qkYuAD8wA",
            "H8D/qw2c61f8nGxnfF7bbJFkZZUHoeWSRTlRvrefauViXVDMpeFa1mK7qGeN3lHBvgRMNEZFX3UT0TlQ5CJF6ZY=",
            "I never signed this"),
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "GbcEJMe6vRtpZ1wrmQ25PndF1qkYuAD8wA",
            "ILU59xaJRW7xFoVKe3+XH9LWq3oCspKKF0DgTGPnRy52O/8oYwfH4Ar7x2dSDkiEGjoZW56T/yibHo3Wp4n8H3U=",
            "Trust me"),
        MessageVerificationResult::OK);
}
...
BOOST_AUTO_TEST_CASE(util_WriteBinaryFile)
{
    ...
    std::string expected_text = "regus";
