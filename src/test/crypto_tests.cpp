...
BOOST_AUTO_TEST_CASE(sha256_testvectors) {
    ...
    TestSHA256("As Regus relies on 80 byte header hashes, we want to have an example for that.",
               "e3cbc905f314d7d9db747a4b3e94d9cbc3932ffe24f3ea6d38c720a570ced25b");
