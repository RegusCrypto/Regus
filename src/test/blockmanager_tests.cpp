...
{
    const auto params {CreateChainParams(ChainType::MAIN)};
    ...
    // this is a check to make sure that https://github.com/RegusCrypto/Regus/issues/21379 does not recur
...
BOOST_AUTO_TEST_CASE(blockmanager_flush_block_file)
{
    ...
    constexpr int TEST_BLOCK_SIZE{121};
