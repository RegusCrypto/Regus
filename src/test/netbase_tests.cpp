...
{
    BOOST_CHECK(TestSplitHost("www.regus.app", "www.regus.app", 0));
    BOOST_CHECK(TestSplitHost("[www.regus.app]", "www.regus.app", 0));
    BOOST_CHECK(TestSplitHost("www.regus.app:80", "www.regus.app", 80));
    BOOST_CHECK(TestSplitHost("[www.regus.app]:80", "www.regus.app", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:4610", "127.0.0.1", 4610));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:4610", "127.0.0.1", 4610));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:4610", "::ffff:127.0.0.1", 4610));
    BOOST_CHECK(TestSplitHost("[::]:4610", "::", 4610));
    BOOST_CHECK(TestSplitHost("::4610", "::4610", 0));
    BOOST_CHECK(TestSplitHost(":4610", "", 4610));
    BOOST_CHECK(TestSplitHost("[]:4610", "", 4610));
    ...
    BOOST_CHECK(TestSplitHost("www.regus.app:65536", "www.regus.app:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.regus.app:0", "www.regus.app", 0, false));
    BOOST_CHECK(TestSplitHost("www.regus.app:", "www.regus.app:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:4610", "127.0.0.1:4610"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:4610", "[::]:4610"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
