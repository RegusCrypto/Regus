...
#ifndef REGUS_INTERFACES_NODE_H
#define REGUS_INTERFACES_NODE_H
...
//! Top-level interface for a regus node (regusd process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or regus.conf.
