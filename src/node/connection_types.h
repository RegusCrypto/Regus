...
#ifndef REGUS_NODE_CONNECTION_TYPES_H
#define REGUS_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/regus-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Regus’s Peer-to-Peer Network")
...
#endif // REGUS_NODE_CONNECTION_TYPES_H
