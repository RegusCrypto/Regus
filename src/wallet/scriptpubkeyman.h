...
#ifndef REGUS_WALLET_SCRIPTPUBKEYMAN_H
#define REGUS_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Regus Core wallet was originally a collection of unrelated private
...
#endif // REGUS_WALLET_SCRIPTPUBKEYMAN_H
