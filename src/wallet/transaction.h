...
#ifndef REGUS_WALLET_TRANSACTION_H
#define REGUS_WALLET_TRANSACTION_H
...
public:
     ...
     * on this regus node, and set to 0 for transactions that were created
...
#endif // REGUS_WALLET_TRANSACTION_H
