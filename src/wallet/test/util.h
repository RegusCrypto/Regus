...
#ifndef REGUS_WALLET_TEST_UTIL_H
#define REGUS_WALLET_TEST_UTIL_H
...
const std::string ADDRESS_RGRT1_UNSPENDABLE = "rgrt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqju08fx";
...
#endif // REGUS_WALLET_TEST_UTIL_H
