...
#ifndef REGUS_WALLET_WALLETUTIL_H
#define REGUS_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! regus from opening the wallet, thinking it was newly created, and
...
#endif // REGUS_WALLET_WALLETUTIL_H
