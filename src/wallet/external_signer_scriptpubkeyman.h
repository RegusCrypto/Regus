...
#ifndef REGUS_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define REGUS_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // REGUS_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
