...
#ifndef REGUS_WALLET_WALLETDB_H
#define REGUS_WALLET_WALLETDB_H
 ...
 * - SQLiteEnvironment is an environment in which the database exists.
...
//! Compacts state so that wallet.dat is self-contained (if there are changes)
