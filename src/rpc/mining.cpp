...
static UniValue GetNetworkHashPS(int lookup, int height, const CChain& active_chain) {
    ...
    if (lookup == -1)
        lookup = pb->nHeight % Params().GetConsensus().nPowTargetWindow * Params().GetConsensus().nPowTargetSpacing + 1;
...
static bool GenerateBlock(ChainstateManager& chainman, CBlock& block, uint64_t& max_tries, std::shared_ptr<const CBlock>& block_out, bool process_new_block)
{
    ...
    uint256 hashMix;
    while (max_tries > 0 && block.nNonce < std::numeric_limits<uint64_t>::max() && !CheckProofOfWork(block.GetHash(hashMix), block.nBits, chainman.GetConsensus()) && !chainman.m_interrupt) {
        ++block.nNonce;
        --max_tries;
    }
...
static RPCHelpMan generatetodescriptor()
{
    return RPCHelpMan{
        ...
        "Mine to a specified descriptor and return the block hashes.",
        {
            ...
            {"descriptor", RPCArg::Type::STR, RPCArg::Optional::NO, "The descriptor to send the newly generated regus to."},
        ...
        "Mine to a specified address and return the block hashes.",
         {
             ...
             {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated regus to."},
             {"maxtries", RPCArg::Type::NUM, RPCArg::Default{DEFAULT_MAX_TRIES}, "How many iterations to try."},
         },
         RPCResult{
             RPCResult::Type::ARR, "", "hashes of blocks generated",
         ...
         RPCExamples{
            ...
            + "If you are using the " PACKAGE_NAME " wallet, you can get a new address to send the newly generated regus to with:\n"
...
static RPCHelpMan generateblock()
{
    return RPCHelpMan{"generateblock",
        ...
        {
            {"output", RPCArg::Type::STR, RPCArg::Optional::NO, "The address or descriptor to send the newly generated regus to."},
...
// NOTE: Unlike wallet RPC (which use REG values), mining RPCs follow GBT (BIP 22) in using satoshi amounts
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    const bool fPreSegWit = !consensusParams.SegwitActive;
...
static RPCHelpMan submitblock()
{
    ...
    return RPCHelpMan{"submitblock",
        ...
        "See https://en.regus.it/wiki/BIP_0022 for full specification.\n",
        {
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
...

    {
        ...
        if (pindex) {
            chainman.UpdateUncommittedBlockStructures(block, pindex, chainman.GetConsensus());
        }
    }
