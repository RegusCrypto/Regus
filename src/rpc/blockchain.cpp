...
UniValue blockheaderToJSON(const CBlockIndex& tip, const CBlockIndex& blockindex)
{
    ...
    result.pushKV("hashMix", blockindex.hashMix.GetHex());
        ...
        {RPCResult::Type::OBJ, "", "",
        {
            ...
            {RPCResult::Type::OBJ, "prevout", "(Only if undo information is available)",
            {
                ...
                {RPCResult::Type::OBJ, "scriptPubKey", "",
                {
                    ...
                    {RPCResult::Type::STR, "address", /*optional=*/true, "The Regus address (only if a well-defined address exists)"},
...
{
    // scriptPubKey corresponding to mainnet address GKTWpTnCLP35XU4BBhZugozBiXS6rdtMZQ
    ...
    return RPCHelpMan{"scantxoutset",
        ...
        "For more information on output descriptors, see the documentation in the docs/descriptors.md file.\n",
        {
...
static RPCHelpMan scanblocks()
{
    return RPCHelpMan{"scanblocks",
        ...
        "This call may take several minutes. Make sure to use no RPC timeout (regus-cli -rpcclienttimeout=0)",
        {
            scan_action_arg_desc,
            scan_objects_arg_desc,
    ...
    const fs::path& temppath)
{
...

    {
        ...
        //
        // See discussion here:
        //   https://github.com/RegusCrypto/Regus/pull/15606#discussion_r274479369
        //
        LOCK(::cs_main);
...
static RPCHelpMan loadtxoutset()
{
    return RPCHelpMan{
        ...
        "The result is a usable regusd instance that is current with the network tip in a "
        ...
        "document (<https://github.com/RegusCrypto/Regus/blob/master/docs/design/assumeutxo.md>).",
        {
            {"path",
                RPCArg::Type::STR,
                RPCArg::Optional::NO,
