...
#ifndef REGUS_RPC_UTIL_H
#define REGUS_RPC_UTIL_H
...
/**
 * Parse a json number or string, denoting REG/kvB, into a CFeeRate (sat/kvB).
 * Reject negative values or rates larger than 1REG/kvB.
 */
