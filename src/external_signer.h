...
#ifndef REGUS_EXTERNAL_SIGNER_H
#define REGUS_EXTERNAL_SIGNER_H
...
//! a hardware wallet. See docs/external-signer.md
...
public:
    ...
    //! @returns see docs/external-signer.md
