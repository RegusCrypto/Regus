...
#ifndef REGUS_IPC_CAPNP_COMMON_TYPES_H
#define REGUS_IPC_CAPNP_COMMON_TYPES_H
...
//! Functions to serialize / deserialize common regus types.
namespace mp {
...
#endif // REGUS_IPC_CAPNP_COMMON_TYPES_H
