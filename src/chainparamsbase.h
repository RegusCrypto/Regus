...
#ifndef REGUS_CHAINPARAMSBASE_H
#define REGUS_CHAINPARAMSBASE_H
...
/**
 * CBaseChainParams defines the base parameters (shared between regus-cli and regusd)
 * of a given instance of the Regus system.
 */
