...
#ifndef REGUS_PROTOCOL_H
#define REGUS_PROTOCOL_H
...
/**
 * Regus protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Regus Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    ...
    // regus-development mailing list. Remember that service bits are just
