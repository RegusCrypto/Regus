    ...
    platformStyle(_platformStyle)
{
    ...
    ui->addressBookButton_SM->setIcon(platformStyle->SingleColorIcon(":/icons/contacts"));
    ui->pasteButton_SM->setIcon(platformStyle->SingleColorIcon(":/icons/paste"));
    ui->copySignatureButton_SM->setIcon(platformStyle->SingleColorIcon(":/icons/copy"));
    ui->signMessageButton_SM->setIcon(platformStyle->SingleColorIcon(":/icons/feather"));
    ui->clearButton_SM->setIcon(platformStyle->SingleColorIcon(":/icons/remove"));
    ui->addressBookButton_VM->setIcon(platformStyle->SingleColorIcon(":/icons/contacts"));
    ui->verifyMessageButton_VM->setIcon(platformStyle->SingleColorIcon(":/icons/question"));
...
void SignVerifyMessageDialog::changeEvent(QEvent* e)
{
    if (e->type() == QEvent::PaletteChange) {
        ui->addressBookButton_SM->setIcon(platformStyle->SingleColorIcon(QStringLiteral(":/icons/contacts")));
        ui->pasteButton_SM->setIcon(platformStyle->SingleColorIcon(QStringLiteral(":/icons/paste")));
        ui->copySignatureButton_SM->setIcon(platformStyle->SingleColorIcon(QStringLiteral(":/icons/copy")));
        ui->signMessageButton_SM->setIcon(platformStyle->SingleColorIcon(QStringLiteral(":/icons/feather")));
        ui->clearButton_SM->setIcon(platformStyle->SingleColorIcon(QStringLiteral(":/icons/remove")));
        ui->addressBookButton_VM->setIcon(platformStyle->SingleColorIcon(QStringLiteral(":/icons/contacts")));
        ui->verifyMessageButton_VM->setIcon(platformStyle->SingleColorIcon(QStringLiteral(":/icons/question")));
