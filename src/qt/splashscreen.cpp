    ...
    : QWidget()
{
    ...
    QString copyrightText   = QString::fromUtf8(CopyrightHolders(strprintf("\xc2\xA9 %u-%u ", 2023, COPYRIGHT_YEAR)).c_str());
    ...
    // draw the regus icon, expected size of PNG: 1024x1024
