...
#ifndef REGUS_QT_OPTIONSMODEL_H
#define REGUS_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Regus client.
...
public:
    ...
    RegusUnit getDisplayUnit() const { return m_display_regus_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSREGontrols() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    RegusUnit m_display_regus_unit;
...
Q_SIGNALS:
    void displayUnitChanged(RegusUnit unit);
