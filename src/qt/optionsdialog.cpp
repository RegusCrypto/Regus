      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->regusAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->regusAtStartup);
    ...
    ui->regusAtStartup->setToolTip(ui->regusAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->regusAtStartup->setText(ui->regusAtStartup->text().arg(PACKAGE_NAME));

    ui->openRegusConfButton->setToolTip(ui->openRegusConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new RegusUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->regusAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSREGontrols);
...
void OptionsDialog::on_openRegusConfButton_clicked()
{
