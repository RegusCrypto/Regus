...
#ifndef REGUS_QT_GUIUTIL_H
#define REGUS_QT_GUIUTIL_H
...
/** Utility functions used by the Regus Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "regus:" URI into recipient object, return true on successful parsing
