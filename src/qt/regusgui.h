...
#ifndef REGUS_QT_REGUSGUI_H
#define REGUS_QT_REGUSGUI_H
...
/**
  Regus GUI main class. This class represents the main window of the Regus UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class RegusGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit RegusGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~RegusGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a regus wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, RegusUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Regus Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(RegusUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // REGUS_QT_REGUSGUI_H
