...
//! Entry point for RegusApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &RegusApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for RegusGUI tests.
void AppTests::guiTests(RegusGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &RegusGUI::consoleShown, this, &AppTests::consoleTests);
