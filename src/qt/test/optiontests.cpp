...
{
    // Test regression https://github.com/RegusCrypto/Regus/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/RegusCrypto/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/RegusCrypto/gui/pull/568.
    // With fListen=false in ~/.config/Regus/Regus-Qt.conf and all else left as default,
    // regus-qt should set both -listen and -listenonion to false and start successfully.
