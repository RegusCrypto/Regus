...
public:
    ...
    QString describe(interfaces::Node& node, interfaces::Wallet& wallet, TransactionRecord* rec, RegusUnit unit)
    {
        ...
        platformStyle(_platformStyle)
{
    ...
    columns << QString() << QString() << tr("Date") << tr("Type") << tr("Label") << RegusUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
{
    columns[Amount] = RegusUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
QVariant TransactionTableModel::txAddressDecoration(const TransactionRecord *wtx) const
{
    ...
    {
    case TransactionRecord::Generated:
        return QIcon(":/icons/shovel");
    case TransactionRecord::RecvWithAddress:
    case TransactionRecord::RecvFromOther:
        return QIcon(":/icons/input");
    case TransactionRecord::SendToAddress:
    case TransactionRecord::SendToOther:
        return QIcon(":/icons/output");
    default:
        return QIcon(":/icons/inout");
    }
}
...
QString TransactionTableModel::formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed, RegusUnits::SeparatorStyle separators) const
{
    QString str = RegusUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), wtx->credit + wtx->debit, false, separators);
    if(showUnconfirmed)
    {
...
QVariant TransactionTableModel::txStatusDecoration(const TransactionRecord *wtx) const
{
    ...
    {
    case TransactionStatus::Unconfirmed:
        return QIcon(":/icons/question");
    case TransactionStatus::Abandoned:
        return QIcon(":/icons/trash");
    case TransactionStatus::Confirming:
        switch(wtx->status.depth)
        {
        case 1: return QIcon(":/icons/clock_1");
        case 2: return QIcon(":/icons/clock_2");
        case 3: return QIcon(":/icons/clock_3");
        case 4: return QIcon(":/icons/clock_4");
        default: return QIcon(":/icons/clock_5");
        };
    case TransactionStatus::Confirmed:
        return QIcon(":/icons/synced");
    case TransactionStatus::Conflicted:
        return QIcon(":/icons/cross");
    case TransactionStatus::Immature: {
        int total = wtx->status.depth + wtx->status.matures_in;
        int part = (wtx->status.depth * 5 / total) + 1;
        return QIcon(QString(":/icons/clock_%1").arg(part));
        }
    case TransactionStatus::NotAccepted:
        return QIcon(":/icons/question");
    default:
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const
{
    ...
    case Qt::DisplayRole:
        ...
        case Amount:
            return formatTxAmount(rec, true, RegusUnits::SeparatorStyle::ALWAYS);
        } // no default case, so the compiler can warn about missing cases
        assert(false);
    case Qt::EditRole:
    ...
    case TxPlainTextRole:
        {
            ...
            details.append(formatTxAmount(rec, false, RegusUnits::SeparatorStyle::NEVER));
            return details;
        }
    case ConfirmedRole:
    ...
    case FormattedAmountRole:
        ...
        return formatTxAmount(rec, false, RegusUnits::SeparatorStyle::NEVER);
    case StatusRole:
