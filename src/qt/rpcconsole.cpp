...
const struct {
    ...
    {"cmd-request", ":/icons/input"},
    {"cmd-reply", ":/icons/output"},
    {"cmd-error", ":/icons/output"},
    {"misc", ":/icons/inout"},
    {nullptr, nullptr}
};
    ...
    platformStyle(_platformStyle)
{
    ...
    ui->fontBiggerButton->setIcon(platformStyle->SingleColorIcon(":/icons/font_bigger"));
    ...
    ui->fontSmallerButton->setIcon(platformStyle->SingleColorIcon(":/icons/font_smaller"));
    ...
    ui->promptIcon->setIcon(platformStyle->SingleColorIcon(QStringLiteral(":/icons/chevron")));
...
void RPCConsole::changeEvent(QEvent* e)
{
    if (e->type() == QEvent::PaletteChange) {
        ...
        ui->fontBiggerButton->setIcon(platformStyle->SingleColorIcon(QStringLiteral(":/icons/font_bigger")));
        ui->fontSmallerButton->setIcon(platformStyle->SingleColorIcon(QStringLiteral(":/icons/font_smaller")));
        ui->promptIcon->setIcon(platformStyle->SingleColorIcon(QStringLiteral(":/icons/chevron")));
...
QIcon RPCConsole::tabIcon(TabTypes tab_type) const
{
    switch (tab_type) {
        case TabTypes::INFO:
            return platformStyle->SingleColorIcon(":/icons/information");
        case TabTypes::CONSOLE:
            return platformStyle->SingleColorIcon(":/icons/console");
        case TabTypes::GRAPH:
            return platformStyle->SingleColorIcon(":/icons/network");
        case TabTypes::PEERS:
            return platformStyle->SingleColorIcon(":/icons/planet");
        default:
            return QIcon();
    }
}
