    ...
    platformStyle(_platformStyle)
{
    ...
    ui->addressBookButton->setIcon(platformStyle->SingleColorIcon(":/icons/contacts"));
    ui->pasteButton->setIcon(platformStyle->SingleColorIcon(":/icons/paste"));
    ...
    // Connect signals
    connect(ui->payAmount, &RegusAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
...
void SendCoinsEntry::changeEvent(QEvent* e)
{
    if (e->type() == QEvent::PaletteChange) {
        ui->addressBookButton->setIcon(platformStyle->SingleColorIcon(QStringLiteral(":/icons/contacts")));
        ui->pasteButton->setIcon(platformStyle->SingleColorIcon(QStringLiteral(":/icons/paste")));
