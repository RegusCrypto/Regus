...
#ifndef REGUS_POLICY_FEERATE_H
#define REGUS_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "REG"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    REG_KVB,      //!< Use REG/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::REG_KVB) const;
