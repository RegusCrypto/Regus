...
#ifndef REGUS_POLICY_POLICY_H
#define REGUS_POLICY_POLICY_H
...
*/
bool AreInputsStandard(const CTransaction& tx, const CCoinsViewCache& mapInputs, bool taprootActive);
/**
