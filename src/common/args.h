...
#ifndef REGUS_COMMON_ARGS_H
#define REGUS_COMMON_ARGS_H
...
extern const char * const REGUS_CONF_FILENAME;
extern const char * const REGUS_SETTINGS_FILENAME;
