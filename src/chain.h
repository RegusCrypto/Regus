...
#ifndef REGUS_CHAIN_H
#define REGUS_CHAIN_H
 ...
 *
 * Ref: https://github.com/RegusCrypto/Regus/pull/1026
 */
...
enum BlockStatus : uint32_t {
     ...
     * flags are removed. See `docs/design/assumeutxo.md` for details.
     *
