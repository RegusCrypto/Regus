...
// Copyright 2015 Regus Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/licenses/mit-license.php.

#ifndef REGUS_UNIVALUE_INCLUDE_UNIVALUE_H
#define REGUS_UNIVALUE_INCLUDE_UNIVALUE_H
...
#endif // REGUS_UNIVALUE_INCLUDE_UNIVALUE_H
