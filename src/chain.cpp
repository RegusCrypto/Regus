...
{
    return strprintf("CBlockIndex(pprev=%p, nHeight=%d,  hashBlock=%s, hashMix=%s, merkle=%s)",
                     pprev, nHeight, GetBlockHash().ToString(), hashMix.ToString(), hashMerkleRoot.ToString());
}
