...
# Use minimum supported python3.9 and gcc-10, see docs/dependencies.md
...
export REGUS_CONFIG="--enable-zmq --with-libs=no --with-gui=qt5 --enable-reduce-exports --enable-debug \
