...
Assumeutxo is a feature that allows fast bootstrapping of a validating regusd
instance.
...
- [Github issue](https://github.com/RegusCrypto/Regus/issues/15605)
- [draft PR](https://github.com/RegusCrypto/Regus/pull/15606)
...
considered active. This is the "traditional" mode of operation for regusd.
...
### Regusd restarts sometime after snapshot validation has completed
