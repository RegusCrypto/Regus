...
- Followed by the actual key, which is either:
  ...
  - `xpub` encoded extended public key or `xprv` encoded extended private key (as defined in [BIP 32](https://github.com/regus/bips/blob/master/bip-0032.mediawiki)).
...
- P2SH addresses (base58, of the form `X...` for mainnet or `S...` for testnet, defined in [BIP 13](https://github.com/regus/bips/blob/master/bip-0013.mediawiki)).
- Segwit addresses (bech32 and bech32m, of the form `rgs...` for mainnet or `rgt...` for testnet, defined in [BIP 173](https://github.com/regus/bips/blob/master/bip-0173.mediawiki) and [BIP 350](https://github.com/regus/bips/blob/master/bip-0350.mediawiki)).
...
the entire path from the master down. [BIP174](https://github.com/regus/bips/blob/master/bip-0174.mediawiki) standardizes this by
