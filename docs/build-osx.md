...
If `sqlite` is installed, then wallet support will also be built.
...
The first time you run `regusd` or `regus-qt`, it will start downloading the blockchain.
